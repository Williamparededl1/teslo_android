          ...
          actions: [
            IconButton(
                onPressed: () async {
                  ...
                  if (galerypath == null) return;
                  ref
                      .read(productFormProvider(productState.product!).notifier)
                      .updateProductImage(galerypath);
                },
                icon: const Icon(Icons.photo)),
            IconButton(
                onPressed: () async {
                  final galeryPaths =
                      await CameraGalleryServiceImpl().selectMultiplePhotos();
                  if (galeryPaths == null) return;
                  ref
                      .read(productFormProvider(productState.product!).notifier)
                      .updateProductImages(galeryPaths);
                },
    ...
    return ListView(
      children: [
        ...
        Center(
          ...
          style: textStyles.titleSmall?.copyWith(fontSize: 20),
...
class _GenderSelector extends StatelessWidget {
  ...
  final void Function(String selectedgender) onGenerChange;

  const _GenderSelector(
      {required this.selectedGender, required this.onGenerChange});
